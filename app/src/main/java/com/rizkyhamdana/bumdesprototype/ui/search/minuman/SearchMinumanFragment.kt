package com.rizkyhamdana.bumdesprototype.ui.search.minuman
...
class SearchMinumanFragment(val query : String): Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        homeViewModel.getDrinkbyQuery(query).observe(viewLifecycleOwner) {
            if(it.isEmpty()){
